...
task :pull do
  ...
  sh "ls rizz-gen/lib/rizz-gen/generators/templates/static/README.rdoc"
end

desc "Pushes repository to GitHub"
task :push => :pull do
  say "Pushing to github..."
  sh "git tag #{Rizz.version}"
  sh "git push origin master"
  sh "git push origin #{Rizz.version}"
end

desc "Release all rizz gems"
...
desc "Run tests for all rizz stack gems"
task :test do
  GEM_PATHS.each do |g|
...
desc "Generate documentation for the Rizz framework"
task :doc do
  require 'yard'
